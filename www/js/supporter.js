...
define('text!templates/ChangeClubSelection.html',[],function () { return '<div class="change-club-selection">\n\n    <div class="intro small">You chose to support</div>\n\n    <div class="club">\n\n    </div>\n\n\n    <p class="medium">IFK Gothenburg</p>\n\n    <a href="#userSettings" class="medium success button full-width js-login">Confirm</a>\n</div>';});

/*global define*/
define('views/ChangeClubSelection',[
    'jquery',
    'underscore',
    'backbone',
    'views/LoggedView',
...
define('text!templates/UserFavorites.html',[],function () { return '<div class="user-favorites">\n\n<p>NO DATA</p>\n<br>\n<a href="#mainMenuLogged" class="medium success button full-width js-login">OK</a>\n</div>';});

/*global define*/

define('views/UserFavorites',[
    'jquery',
    'underscore',
    'backbone',
    'views/LoggedView',
...
define('text!templates/OperatorsList.html',[],function () { return '<div class="operators-list">\n    <ul class="intro">\n        <li class="large operator"><div class="operator-name">Ladbrokes</div>\n            <div class="switch">\n              <input id="betsafe" type="checkbox">\n              <label for="betsafe"></label>\n            </div>\n        </li>\n        <li class="large operator"><div class="operator-name">Mr Green</div>\n            <div class="switch">\n              <input id="bettson" type="checkbox">\n              <label for="bettson"></label>\n            </div>\n        </li>\n        <li class="large operator"><div class="operator-name">888</div>\n            <div class="switch">\n              <input id="nordicbet" type="checkbox">\n              <label for="nordicbet"></label>\n            </div>\n        </li>\n        <li class="large operator"><div class="operator-name">Unibet</div>\n            <div class="switch">\n              <input id="betsafe" type="checkbox">\n              <label for="betsafe"></label>\n            </div>\n        </li>\n        <li class="large operator"><div class="operator-name">Bwin</div>\n            <div class="switch">\n              <input id="bettson" type="checkbox">\n              <label for="bettson"></label>\n            </div>\n        </li>\n        <li class="large operator"><div class="operator-name">Svenska Spiel</div>\n            <div class="switch">\n              <input id="nordicbet" type="checkbox">\n              <label for="nordicbet"></label>\n            </div>\n        </li>\n    </ul>\n</div>';});

/*global define*/

define('views/OperatorsList',[
    'jquery',
    'underscore',
    'backbone',
    'views/LoggedView',
...
define('text!templates/About.html',[],function () { return '<div class="about">\n\n    <p>\n    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer quis ipsum ut purus posuere hendrerit. Nulla non sem nunc. Nullam nisi arcu, gravida at pellentesque vel, tempor id enim. Cras eget lorem et mi lacinia rutrum. Phasellus accumsan metus sit amet urna malesuada, vel placerat augue.Sed posuere blandit. Nulla non sem nunc. Nullam nisi arcu, gravida at pellentesque vel, tempor id enim. Praesent tincidunt condimentum lorem. Sed posuere blandit. Praesent tincidunt condimentum lorem.\n    </p>\n\n</div>';});
...
define('views/DeleteUserAccount',[
    'jquery',
    'underscore',
    'backbone',
    'views/LoggedView',
...
define('views/ChangeUserPassword',[
    'jquery',
    'underscore',
    'backbone',
    'views/LoggedView',
...
define('text!templates/DeleteUserAccountDone.html',[],function () { return '<div class="delete-user-account-done">\n\t<div class="text small">Your account has been deleted.</div>\n\t<a href="#menuLogClear" class="medium success button full-width">OK</a><br>\n</div>';});

/*global define*/

define('views/DeleteUserAccountDone',[
    'jquery',
    'underscore',
    'backbone',
    'views/LoggedView',
...
define('text!templates/UserBets.html',[],function () { return '<div class="user-bets">\n\t<div class="title large">User Bets (2)</div>\n\t<div class="bets">\n\t\t<div class="bet">\n\t\t\t<div class="block game-data small">\n\t\t\t\t2014-03-05 18:00 - Match winner (1 X 2)\n\t\t\t</div>\n\t\t\t<div class="block game-match small">\n\t\t\t\tChelsea - Arsenal\n\t\t\t</div>\n\t\t\t<div class="block">\n\t\t\t\t<div class="small-6 columns operator medium">Operator</div>\n\t\t\t\t<div class="small-6 columns bets-options">\n\t\t\t\t\t<div class="left small bet-option selected">2.05</div>\n\t\t\t\t\t<div class="left small bet-option">3.40</div>\n\t\t\t\t\t<div class="left small bet-option">1.03</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div class="block">\n\t\t\t\t<div class="small-6 columns player-bet">\n\t\t\t\t\t<div class="left small">You bet:</div>\n\t\t\t\t\t<div class="right medium">€50</div>\n\t\t\t\t</div>\n\t\t\t\t<div class="small-6 columns potential-win">\n\t\t\t\t\t<div class="left small">Potential win:</div>\n\t\t\t\t\t<div class="right medium">€2500</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div class="block donation small">\n\t\t\t\t<span class="text">Donation recipient:</span>\n\t\t\t\t<span class="club">Hammarby Fotboll ff</span>\n\t\t\t</div>\n\t\t</div>\n\t\t\n\t\t\n\t\t\n\t\t\n\t\t<div class="bet">\n\t\t\t<div class="block game-data small">\n\t\t\t\t2014-03-05 18:00 - Match winner (1 X 2)\n\t\t\t</div>\n\t\t\t<div class="block game-match small">\n\t\t\t\tChelsea - Arsenal\n\t\t\t</div>\n\t\t\t<div class="block">\n\t\t\t\t<div class="small-6 columns operator medium">Operator</div>\n\t\t\t\t<div class="small-6 columns bets-options">\n\t\t\t\t\t<div class="left small bet-option selected">2.05</div>\n\t\t\t\t\t<div class="left small bet-option">3.40</div>\n\t\t\t\t\t<div class="left small bet-option">1.03</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div class="block">\n\t\t\t\t<div class="small-6 columns player-bet">\n\t\t\t\t\t<div class="left small">You bet:</div>\n\t\t\t\t\t<div class="right medium">€50</div>\n\t\t\t\t</div>\n\t\t\t\t<div class="small-6 columns potential-win">\n\t\t\t\t\t<div class="left small">Potential win:</div>\n\t\t\t\t\t<div class="right medium">€2500</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div class="block donation small">\n\t\t\t\t<span class="text">Donation recipient:</span>\n\t\t\t\t<span class="club">Hammarby Fotboll ff</span>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>';});

/*global define*/

define('views/UserBets',[
    'jquery',
    'underscore',
    'backbone',
    'views/LoggedView',
...
define('text!templates/UserWallet.html',[],function () { return '<div class="user-wallet">\n\t<div class="row title">\n\t\t<div class="columns small-4">Operator</div>\n\t\t<div class="columns small-4">Balance</div>\n\t\t<div class="columns small-4">Deposit</div>\n\t</div>\n\t<div class="wallet-list">\n\t\t<div class="row medium wallet-item">\n\t\t\t<div class="columns small-4 operator">Betsafe</div>\n\t\t\t<div class="columns small-4 balance">770€</div>\n\t\t\t<div class="columns small-4 deposit">\n\t\t\t\t<a href="#" class="medium secondary button">Register</a>\n\t\t\t</div>\n\t\t</div>\n\t\t<div class="row medium wallet-item">\n\t\t\t<div class="columns small-4 operator">Betson</div>\n\t\t\t<div class="columns small-4 balance">80€</div>\n\t\t\t<div class="columns small-4 deposit">\n\t\t\t\t<a href="#" class="medium secondary button">Register</a>\n\t\t\t</div>\n\t\t</div>\n\t\t<div class="row medium wallet-item">\n\t\t\t<div class="columns small-4 operator">888</div>\n\t\t\t<div class="columns small-4 balance">200€</div>\n\t\t\t<div class="columns small-4 deposit">\n\t\t\t\t<a href="#" class="medium secondary button">Register</a>\n\t\t\t</div>\n\t\t</div>\n\t\t<div class="row medium wallet-item">\n\t\t\t<div class="columns small-4 operator">Nordicbet</div>\n\t\t\t<div class="columns small-4 balance">10€</div>\n\t\t\t<div class="columns small-4 deposit">\n\t\t\t\t<a href="#" class="medium secondary button">Register</a>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>';});

/*global define*/

define('views/UserWallet',[
    'jquery',
    'underscore',
    'backbone',
    'views/LoggedView',
...
define('text!templates/UserStatistics.html',[],function () { return '<div class="user-statistics">\n\t<div class="title medium">\n\t\t<div>Donations to</div>\n\t\t<div class="club">AIK FF</div>\n\t\t<div>via Supporter.se</div>\n\t</div>\n\t<div class="user-history-chart">\n\t\t<img src="img/chart.png" />\n\t</div>\n\t<div class="user-history-list small">\n\t\t<div class="row">\n\t\t\t<div class="columns small-6 blue">Donated By You</div>\n\t\t\t<div class="columns small-6 yellow">Donated By All</div>\n\t\t</div>\n\t\t<div class="row green">\n\t\t\t<div class="columns small-6">€120</div>\n\t\t\t<div class="columns small-6">€126,621</div>\n\t\t</div>\n\t</div>\n\t<div class="all-users-history-list row small">\n\t\t<div class="columns small-6">\n\t\t\t<div class="row">\n\t\t\t\t<div class="left">Betsson</div>\n\t\t\t\t<div class="right">€85</div>\n\t\t\t</div>\n\t\t\t<div class="row">\n\t\t\t\t<div class="left">Betsafe</div>\n\t\t\t\t<div class="right">€0</div>\n\t\t\t</div>\n\t\t\t<div class="row">\n\t\t\t\t<div class="left">Nordicbet</div>\n\t\t\t\t<div class="right">€35</div>\n\t\t\t</div>\n\t\t</div>\n\t\t<div class="columns small-6">\n\t\t\t<div class="row">\n\t\t\t\t<div class="left">Betsson</div>\n\t\t\t\t<div class="right">€12,085</div>\n\t\t\t</div>\n\t\t\t<div class="row">\n\t\t\t\t<div class="left">Betsafe</div>\n\t\t\t\t<div class="right">€15,010</div>\n\t\t\t</div>\n\t\t\t<div class="row">\n\t\t\t\t<div class="left">Nordicbet</div>\n\t\t\t\t<div class="right">€99,520</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>';});

/*global define*/

define('views/UserStatistics',[
    'jquery',
    'underscore',
    'backbone',
    'views/LoggedView',
...
define('views/DeleteUserAccountConfirm',[
    'jquery',
    'underscore',
    'backbone',
    'views/LoggedView',
...
define('text!templates/EventsAllFilter.html',[],function () { return '<div class="events-all-filter">\n\n<p>\n    BETTING PROCESS\n</p>\n<br>\n<br>\n\n<a class="medium success button full-width js-back">Go Back</a>\n\n</div>';});

/*global define*/

define('views/EventsAllFilter',[
    'jquery',
    'underscore',
    'backbone',
    'views/LoggedView',
...
define("offcanvas", ["jquery","foundation"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.offcanvas;
    };
}(this)));
